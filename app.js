...
//  });
  ...
  app.get("/", (req, res) => {
    res.sendFile(path.join(__dirname, "web-portfolio", "build", "index.html"));
  });
  app.use("/", express.static(path.join(__dirname, "web-portfolio", "build")));
  ...
  app.use( "/markdown-preview", express.static(path.join(__dirname, "markdown-preview", "build")));
  ...
  app.use( "/random-quote-machine", express.static(path.join(__dirname, "random-quote-machine", "build")));


  app.get("/tribute-page", (req, res) => {
    res.sendFile(
      path.join(__dirname, "tribute-page", "index.html")
    );
  });
  app.use( "/tribute-page", express.static(path.join(__dirname, "tribute-page")));
...
app.get("/tribute-page-v2", (req, res) => {
  ...
  app.use( "/tribute-page-v2", express.static(path.join(__dirname, "tribute-page-v2", "build")));


  app.get("/web-resume", (req, res) => {
    res.sendFile(path.join(__dirname, "web-resume", "build", "index.html"));
  });
  app.use("/web-resume", express.static(path.join(__dirname, "web-resume", "build")));
